...
if(isset($_GET['id'])&&$_GET['id']==$_SESSION['user']):
$information = selectWhere('*','Gebruiker', 'Gebruikersnaam = ?', [$_SESSION['user']]);
$telephone = selectWhere('*','Gebruikerstelefoon', 'Gebruikersnaam = ?', [$_SESSION['user']]);
$validation = array();
if(isset($_POST['change'])):
  ...
  if(!$validation):
    ...
    $_POST['plaatsnaam'],$_POST['adresregel1'],$_POST['adresregel2'],$_POST['GeboorteDag'],$_POST['postcode'],$_SESSION['user']);
    ...
    $sql->execute(array($_POST['Telefoon'],$_SESSION['user']));
...
<form class="form-horizontal" action="" method="post">
  ...
  <div class="form-group">
     <div class="col-sm-offset-2 col-sm-20">
       <button type="submit" class="btn btn-success" name="change">Aanpassen</button>
     </div>
   </div>
</form>
</div>
